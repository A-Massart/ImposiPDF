...
# Exemple pour ton icône ou autres fichiers
ICON_PATH = os.path.join(BASE_DIR, "logo-imposition.ico")
...
def impose_booklet(input_pdf, output_pdf, add_crop_marks=True, bleed_mm=5, output_format="A4"):
    ...
    PAGE_MAPPING = {"A5": "A5", "A4": "A5", "A3": "A4", "A2": "A3"}
...
preview_label = ctk.CTkLabel(right, text="Aucun PDF sélectionné", font=("Arial", 16), image=placeholder_img)
